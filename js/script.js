                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data.data.length; i++) {
                           ...
                           html+=" <div class='row personnel_row'>"+"<div class='col-sm personnel_col'>"+data_values[i].lastName+", "+data_values[i].firstName +"</div><div class='col-sm personnel_col'>"+(data_values[i].department ? data_values[i].department : '-')+"</div><div class='col-sm personnel_col'>"+(data_values[i].location ? data_values[i].location : '-')+"</div><div class='col-sm personnel_col personnel_col_button'>"+"<button type='button' class='btn btn-success btn_edit' data-id=" + data_values[i].id + " data-toggle='modal' data-target='#exampleModal'>Edit</button><button type='button' class='btn btn-danger btn_delete name_id_" + data_values[i].id + "' data-name='"+data_values[i].firstName+"'  onclick='myConfirm_disabled(" + data_values[i].id + ")' type='button'  data-id=" + data_values[i].id + " >Delete</button>" +"</div></div>";
                    ...
                    success: function(data) {
                        ...
                        for (var d = 0; d < data.data.length; d++) {
                           ...
                           // html_department += "<tr><td>" + data_values_department[d].dep_name + "</td><td>" + (data_values_department[d].loc_name ?data_values_department[d].loc_name:'-' ) + "</td><td>" + "<button type='button' class='btn btn-success btn_dept_edit ' data-id=" + data_values_department[d].dep_id + " data-toggle='modal' data-target='#department_modal'>Edit</button><button type='button' class=' btn btn-danger btn_delete departement_id"+data_values_department[d].dep_id +"' data-name="+data_values_department[d].dep_name+" onclick='myConfirm_dep(" + data_values_department[d].dep_id + ")' type='button'  data-id=" + data_values_department[d].dep_id + " >Delete</button>" + "</td></tr>";
                            html_department+=" <div class='row personnel_row'>"+"<div class='col-sm personnel_col'>"+data_values_department[d].dep_name+"</div><div class='col-sm personnel_col'>"+(data_values_department[d].loc_name ?data_values_department[d].loc_name:'-' ) +"</div><div class='col-sm personnel_col personnel_col_button'>"+"<button type='button' class='btn btn-success btn_dept_edit ' data-id=" + data_values_department[d].dep_id + " data-toggle='modal' data-target='#department_modal'>Edit</button><button type='button' class=' btn btn-danger btn_delete departement_id"+data_values_department[d].dep_id +"' data-name="+data_values_department[d].dep_name+" onclick='myConfirm_dep(" + data_values_department[d].dep_id + ")' type='button'  data-id=" + data_values_department[d].dep_id + " >Delete</button>" +"</div></div>";
    ...
    var id = e;
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    if(response.status.description == 'Location Already Used in Department table')
                    {
                     swal("Cancelled", response.status.description , "error");
 
                    }
					
					 else if (response.status.description == 'success') {
    ...
    var id = e;
	 ...
	 $.ajax({
                ...
                success:function(response){
                    ...
                    if(response.status.description == 'Department Already Used in Personnel table')
                   {
                    swal("Cancelled", response.status.description , "error");
            ...
            $.ajax({
                ...
                success: function(data) {
                   ...
                   // html += "<tr><td>" + data.data.personnel[i].lastName + ", " + data.data.personnel[i].firstName + "</td><td>" + data.data.personnel[i].dept_name + "</td><td>" + data.data.personnel[i].loc_name + "</td><td>" + "<button type='button' class='btn btn-success btn_edit' data-id=" + data.data.personnel[i].id + " data-toggle='modal' data-target='#exampleModal'>Edit</button><button type='button' class='btn btn-danger btn_delete name_id_" + data.data.personnel[i].id + "' data-name='"+data.data.personnel[i].firstName+"' onclick='myConfirm_disabled(" + data.data.personnel[i].id + ")' type='button'  data-id=" + data.data.personnel[i].id + " >Delete</button> " + "</td></tr>";
                    html+=" <div class='row personnel_row'>"+"<div class='col-sm personnel_col'>"+data.data.personnel[i].lastName+", "+data.data.personnel[i].firstName +"</div><div class='col-sm personnel_col'>"+(data.data.personnel[i].dept_name ? data.data.personnel[i].dept_name : '-')+"</div><div class='col-sm personnel_col'>"+(data.data.personnel[i].loc_name ? data.data.personnel[i].loc_name : '-')+"</div><div class='col-sm personnel_col personnel_col_button'>"+"<button type='button' class='btn btn-success btn_edit' data-id=" + data.data.personnel[i].id + " data-toggle='modal' data-target='#exampleModal'>Edit</button><button type='button' class='btn btn-danger btn_delete name_id_" + data.data.personnel[i].id + "' data-name='"+data.data.personnel[i].firstName+"'  onclick='myConfirm_disabled(" + data.data.personnel[i].id + ")' type='button'  data-id=" + data.data.personnel[i].id + " >Delete</button>" +"</div></div>";
                 ...
                 else if (table_name=='department')
                 {
                   ...
                   // html_department += "<tr><td>" + data.data.personnel[i].name + "</td><td>" + data.data.personnel[i].loc_name + "</td><td>" + "<button type='button' class='btn btn-success btn_dept_edit' data-id=" + data.data.personnel[i].id + " data-toggle='modal' data-target='#department_modal'>Edit</button><button type='button' class='btn btn-danger btn_delete' onclick='myConfirm_dep(" + data.data.personnel[i].id + ")' type='button'  data-id=" + data.data.personnel[i].id + " >Delete</button>" + "</td></tr>";
                    ...
                    html_department+=" <div class='row personnel_row'>"+"<div class='col-sm personnel_col'>"+data.data.personnel[i].name+"</div><div class='col-sm personnel_col'>"+(data.data.personnel[i].loc_name ?data.data.personnel[i].loc_name:'-' ) +"</div><div class='col-sm personnel_col personnel_col_button'>"+"<button type='button' class='btn btn-success btn_dept_edit ' data-id=" + data.data.personnel[i].id + " data-toggle='modal' data-target='#department_modal'>Edit</button><button type='button' class=' btn btn-danger btn_delete departement_id"+data.data.personnel[i].id +"' data-name="+data.data.personnel[i].dep_name+" onclick='myConfirm_dep(" + data.data.personnel[i].id + ")' type='button'  data-id=" + data.data.personnel[i].id + " >Delete</button>" +"</div></div>";
                    }
